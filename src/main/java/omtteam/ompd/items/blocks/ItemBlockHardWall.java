...
public class ItemBlockHardWall extends ItemBlock {
    public ItemBlockHardWall(Block block) {
        super(block);
        setHasSubtypes(true);
    }

    public final static String[] subNames = {
            Names.Blocks.hardWallTierOne, Names.Blocks.hardWallTierTwo,Names.Blocks.hardWallTierThree,
            Names.Blocks.hardWallTierFour,Names.Blocks.hardWallTierFive
    };
